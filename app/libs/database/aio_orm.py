...
class _Update:
    ...
    @overload
    def where(self, condexp: callable, whereclause):
        """
        :rtype: _Update
        """
        pass
    ...
    def where(self, *clauses):
        ...
        :rtype: _Update
        """
        whereclause = _format_where(clauses)
        if whereclause is not None:
            self._update = self._update.where(whereclause)
        return self
...
class _Select:
    ...
    @overload
    def where(self, whereclause) -> '_Select':
        """
        :rtype: _Select
        """
        pass
    ...
    @overload
    def where(self, condexp, whereclause) -> '_Select':
        """
        :param condexp:
        :param whereclause:
        :return:
    ...
    def where(self, *clauses) -> '_Select':
        ...
        whereclause = _format_where(clauses)
        if whereclause is not None:
            self._select = self._select.filter(whereclause)
        return self
    ...
    def select_entity_from(self, from_obj):
        self._select = self._select.select_entity_from(from_obj)
        return self

    @overload
    def order_by(self, condexp: bool, whereclause):
        """
        :rtype: _Select
        """
        pass
...
class _Delete:
    ...
    @overload
    def where(self, condexp, whereclause):
        """
        :rtype: _Delete
        """
        pass
    ...
    def where(self, *clauses):
        whereclause = _format_where(clauses)
        if whereclause is not None:
            self._delete = self._delete.where(whereclause)
        return self
...
def condition_clause(condexp: any, criterion):
    ret = condexp
    if callable(condexp):
        ret = condexp()
        ...
        try:
            ...
            if self._use_pool:
                if self._pool is None:
                    self._pool = await create_pool(command_timeout=self._timeout)
    ...
    async def commit(self):
        async with self._locker:
            if self._tx is not None:
                if self._tx._state != TransactionState.STARTED:
                    return
